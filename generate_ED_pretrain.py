...
model_names = os.listdir('saved_models/ED/')
for name in model_names:
    print('ED - Model name: ' + name)
    d_model = 512
    ...
    checkpoint = torch.load(f'saved_models/ED/{name}', map_location=device_name)
