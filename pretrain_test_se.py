...
def main():
    ...
    os.makedirs('results/SE_test/', exist_ok=True)
    results_path = 'results/SE_test/' + 'pretraining.csv'

    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs('saved_models/SE_test/', exist_ok=True)
    save_dir = 'saved_models/SE_test/'
