...
if __name__ == "__main__":
    ...
    compute_and_save_html_results_by_setup(
        ...
        melody_track_index=0,
        grouping_threshold=0.05,
        output_html="results/results_pretrained_jazz.html"
    )

    ground_truth_path = "./MIDIs/nottingham/real"          # folder with the ground-truth MIDIs
    root_folder       = "./MIDIs/nottingham/gen"   # folder containing setups; each setup has instance folders
    ...
    compute_and_save_html_results_by_setup(
        ...
        melody_track_index=0,
        grouping_threshold=0.05,
        output_html="results/results_pretrained_nottingham.html"
    )