from generate_utils import generate_files_with_nucleus, load_EDASModel, get_actisteer_guidance
...
results_base_path = 'results/ED/pbp/ActivationSteering'
    ...
    for alpha in [2.5, 5.0]:
        ...
        for h_idx in range(len(source_files)):
            for g_idx in guide_idxs[h_idx]:
                ...
                mxl_folder_out = None
                prefix = 'gen/ED/'
                midi_folder_out = f'MIDIs/jazz2nott_pbp/{prefix}{folder_name}'
